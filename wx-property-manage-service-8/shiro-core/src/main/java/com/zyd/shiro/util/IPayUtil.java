...
public class IPayUtil {
    ...
    public static Map<String, String> xmlToMap(String strXML) throws Exception {
        try {
            ...
            IPayUtil.getLogger().warn("Invalid XML, can not convert to map. Error message: {}. XML content: {}",
    ...
    public static Logger getLogger() {
        Logger logger = LoggerFactory.getLogger("ipay java sdk");
        return logger;
    }
    ...
    public static String generateSignedXml(final Map<String, String> data, String key)
        ...
        data.put(IPayConstants.FIELD_SIGN, sign);
    ...
    public static boolean rsa256CheckContent(String content, String sign, String key)
            throws Exception {
        try {
            IPayUtil.getLogger().info("公钥字符串： "+key);
            ...
            IPayUtil.getLogger().info("验签结果： "+result);
            return result;
        } catch (Exception e) {
    ...
    public static String coverMap2String(Map<String, String> data) {
        ...
        while (it.hasNext()) {
            ...
            if (IPayConstants.FIELD_SIGN.equals(en.getKey().trim())) {
                continue;
            }
        ...
        while (it.hasNext()) {
            Entry<String, String> en = it.next();
            sf.append(en.getKey() + IPayConstants.EQUAL + en.getValue() + IPayConstants.AMPERSAND);
        }
