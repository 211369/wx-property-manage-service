package com.zyd.shiro.pdf.kit.util;

import com.zyd.shiro.pdf.kit.component.PDFKit;
import com.zyd.shiro.pdf.kit.exception.FreeMarkerException;
...
public class FreeMarkerUtil {
    ...
    private static Map<String,FileTemplateLoader> fileTemplateLoaderCache=new HashMap<>();

    private static  Map<String,Configuration> configurationCache= new HashMap<>();
    ...
    public static String getPDFTemplatePath(String fileName) {
        ...
        String templatePath = classpath + "/templates/pdftemps";
