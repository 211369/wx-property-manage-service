...
<#--        <div id="carTableMain" style="display: none;"><table id="receivableCarTable"></table></div>-->
        ...
        <table id="receivableTableExport" class="table table-bordered">
            <thead>
                <tr><th colspan="15" id="exportTitle">车位费实收统计表</th></tr>
                <tr><th colspan="15" id="exportSearchTime" style="text-align:left;"></th></tr>
                <tr>
                    <th rowspan="2">车位类型</th>
...
<script>
    ...
    $(function () {
        initLayDate();
        queryVillage();
        $(".searchForm #costName").html(costTypeToCostName("车位费"));
    })
    ...
    function getProOrCarReceiveList(flag) {
        ...
        $("#receivableProTable").bootstrapTable('destroy').bootstrapTable({
            ...
            columns:[
                [
                    {field: 'costName', title: '车位类型', rowspan: 2},
